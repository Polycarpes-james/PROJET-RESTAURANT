...
@section('content_second')
    <div class="horaires-reservation">
        {{-- <div class="horaires-item"> --}}
            ...
            <div class="picture-part"></div> --}}
            {{-- <img src="{{ asset("/44-Breeze-Angle-2-1-scaled-aspect-ratio-1366-768-scaled.jpg") }}" alt=""> --}}

        {{-- </div> --}}
        <img src="{{ asset('img/outil-de-reveil-circulaire.png') }}" alt="">
