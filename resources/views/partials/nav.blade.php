<header class="main-header-content {{ $background_header ?? null }}">
    ...
    <div class="inscription-users">
        <a href="{{ auth()->check() ? route('rettine.panier') : route('invite.panier', ['invite_id' => Cookie::get('invite_id')]) }}" id="ouvrirPanierBtn" class="btn btn-open-modal">
